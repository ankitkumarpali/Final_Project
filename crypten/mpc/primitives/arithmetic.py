...
class ArithmeticSharedTensor(object):
    ...
    def conv3d(self, kernel, **kwargs):
        return self._arithmetic_function(kernel, "conv3d", **kwargs)
    ...
    def conv_transpose3d(self, kernel, **kwargs):
        """Perform a 2D transpose convolution (deconvolution) using the given kernel"""
        return self._arithmetic_function(kernel, "conv_transpose3d", **kwargs)
