...
def conv3d(x, y, **kwargs):
    return __replicated_secret_sharing_protocol("conv3d", x, y, **kwargs)
...
def conv_transpose3d(x, y, **kwargs):
    return __replicated_secret_sharing_protocol("conv_transpose3d", x, y, **kwargs)
