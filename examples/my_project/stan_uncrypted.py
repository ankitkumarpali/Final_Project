...
#     torch.save(train_data, 'tensor.pt')
    ...
    train_data = torch.load('/data/home/ankitkumar15/CrypTen/examples/my_project/train_jason_murpy_tensor.pt')
    label = torch.load('/data/home/ankitkumar15/CrypTen/examples/my_project/train_jason_murpy.pt')
